...
class LocaleCreateCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $mediaLocale = resource_path('lang/vendor/media/en');
        if (File::exists($mediaLocale)) {
            File::copyDirectory($mediaLocale, resource_path('lang/vendor/media/' . $this->argument('locale')));
            $this->info('Created: ' . resource_path('lang/vendor/media/' . $this->argument('locale')));
        }
