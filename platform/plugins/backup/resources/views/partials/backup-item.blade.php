<tr class="@if (!empty($odd) && $odd == true) odd @else even @endif">
    ...
    <td style="width: 150px;">
        ...
        <a href="#" data-section="{{ route('backups.delete', $key) }}" class="text-danger deleteDialog" data-toggle="tooltip" title="{{ trans('core/base::tables.delete_entry') }}"><i class="icon icon-trash"></i></a>
