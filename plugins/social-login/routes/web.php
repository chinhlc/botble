...
Route::group(['namespace' => 'Botble\SocialLogin\Http\Controllers', 'middleware' => 'web'], function () {
    ...
    Route::get('auth/{provider}', ['as' => 'auth.social', 'uses' => 'SocialLoginController@redirectToProvider']);
    Route::get('auth/callback/{provider}', ['as' => 'auth.social.callback', 'uses' => 'SocialLoginController@handleProviderCallback']);
